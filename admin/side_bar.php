        ...
        while ($row = $query->fetch_array()) {
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" style = "color: white">
                    <i class="fa fa-cog fa-spin fa-fw"></i>Welcome: <?php echo $admin_adminname = $user_row['firstname'] . " " . $user_row['lastname']; ?>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="../registerVoters/register_index.php"><i class = "fa fa-user fa-fw"></i> Add Voters</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
