        ...
        <div id="page-wrapper">
            <div class="row">
                ...
                <div class="panel panel-default">
                    ...
                    <br/>
                    <form method="post" action="canversingSearch.php">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <?php
                            require 'db_connection.php';
                            $query = $conn->query("SELECT * FROM candidate WHERE designation = 'PIO'");
                            while ($fetch = $query->fetch_array()) {
                                $id = $fetch['candidate_id'];
                                $query1 = $conn->query("SELECT COUNT(*) as total FROM `vote` WHERE candidate_id = '$id'");
                                $fetch1 = $query1->fetch_assoc();
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <?php
                            require 'db_connection.php';
                            $query = $conn->query("SELECT * FROM candidate WHERE designation = 'Business Manager'");
                            while ($fetch = $query->fetch_array()) {
                                $id = $fetch['candidate_id'];
                                $query1 = $conn->query("SELECT COUNT(*) as total FROM `vote` WHERE candidate_id = '$id'");
                                $fetch1 = $query1->fetch_assoc();
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <?php
                            require 'db_connection.php';
                            $query = $conn->query("SELECT * FROM candidate WHERE designation = 'Sgt. @ Arms'");
                            while ($fetch = $query->fetch_array()) {
                                $id = $fetch['candidate_id'];
                                $query1 = $conn->query("SELECT COUNT(*) as total FROM `vote` WHERE candidate_id = '$id'");
                                $fetch1 = $query1->fetch_assoc();
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <?php
                            require 'db_connection.php';
                            $query = $conn->query("SELECT * FROM candidate WHERE designation = 'Muse'");
                            while ($fetch = $query->fetch_array()) {
                                $id = $fetch['candidate_id'];
                                $query1 = $conn->query("SELECT COUNT(*) as total FROM `vote` WHERE candidate_id = '$id'");
                                $fetch1 = $query1->fetch_assoc();
                        ...
                        <table class="table table-striped table-bordered table-hover ">
                            ...
                            <?php
                            require 'db_connection.php';
                            $query = $conn->query("SELECT * FROM candidate WHERE designation = 'Escort'");
                            while ($fetch = $query->fetch_array()) {
                                $id = $fetch['candidate_id'];
                                $query1 = $conn->query("SELECT COUNT(*) as total FROM `vote` WHERE candidate_id = '$id'");
                                $fetch1 = $query1->fetch_assoc();
