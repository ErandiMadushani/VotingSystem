    ...
    <form method = "POST" action = "vote_result.php">
                ...
                <div class="panel-body" style = "background-color:;">
                    ...
                    while ($fetch = $query->fetch_array()) {
                        ...
                        <div id = "designation">
                            ...
                            <center>
                                <button type="button" class="btn btn-primary btn-xs" style = "border-radius:60px;margin-top:4px;"><?php echo $fetch['firstname'] . " " . $fetch['lastname'] ?>
                                </button>
                            </center>

                            <center>
                                <input type = "checkbox" value = "<?php echo $fetch['candidate_id'] ?>" name ="pres_id" class = "president">
                            </center>
                        </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body" style = "background-color:;">
                    <?php
                    $query = $conn->query("SELECT * FROM `candidate` WHERE `designation` = 'Treasure'") or die(mysqli_errno());
                    while ($fetch = $query->fetch_array()) {
                        ?>
                        <div id = "position">
                            <img src = "admin/<?php echo $fetch['img'] ?>" style ="border-radius:6px;" height = "150px" width = "150px" class = "img">
        ...
        <center><button class = "btn btn-success ballot" type = "submit" name = "submitVote"> Submit Your Vote</button></center>
    </form>
</body>
